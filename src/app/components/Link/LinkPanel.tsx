...
export default function LinkPanel({ show }: { show: boolean }) {
  return (
    <motion.div
      ...
      className={`absolute z-40 top-20 left-4/9 -translate-x-1/2 w-[600px] bg-gradient-to-br from-gray-900 to-black border-4 border-amber-700 rounded-xl shadow-[0_0_30px_rgba(255,191,0,0.4)] p-6 ${cinzel.className}`}
    >
