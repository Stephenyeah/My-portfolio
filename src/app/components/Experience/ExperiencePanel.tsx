...
export default function ExperiencePanel({
  ...
  return (
    <motion.div
      ...
      className="absolute top-4/11 left-2/5 -translate-x-1/2 -translate-y-1/2 z-40 w-[1250px] max-h-[90vh] min-h-[680px] bg-gradient-to-br from-black to-gray-900 border-4 border-amber-700 rounded-xl shadow-[0_0_40px_rgba(255,191,0,0.3)] p-8 flex flex-col"
    >
